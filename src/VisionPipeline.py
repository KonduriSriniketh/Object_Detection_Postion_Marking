...
class VisionPipieline():
    ...
    ### Custom Hazard Dataset ###
    def __init__(self):
        #self.weights='/home/sutd/ROS2_AI/trained_wts/exp4/weights/best.pt'
        #self.data='/home/sutd/ROS2_AI/trained_wts/exp4/Interior_Furniture_20_03_23.yaml'
    ...
    ### Human dataset ###
    # def __init__(self):
    #     self.weights='/home/sutd/ROS2_AI/yolov5/yolov5m.pt'
    #     self.data='/home/sutd/ROS2_AI/yolov5/models/yolov5m.yaml'
    #     self.imgsz=(640, 640)  # inference size (height, width)
    #     self.conf_thres = 0.25
    #     self.iou_thres = 0.45
    #     self.max_det=1000  # maximum detections per image
